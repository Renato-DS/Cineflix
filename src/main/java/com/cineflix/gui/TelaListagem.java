...
import com.cineflix.persistencia.FilmesBD;
import com.cineflix.persistencia.Filmes;
    ...
    if(tblFilmes.getSelectedRow() >= 0){ 
        if(!tblFilmes.getValueAt(tblFilmes.getSelectedRow(), 5).equals("Encerrado")) {
              ...
              {   
                  ...
                  JOptionPane.showMessageDialog(this, "Filme encerrado com sucesso, obrigado por assistir!");
              }
